---
name: log-lesson
description: Capture a correction, wrong turn or reusable discovery in docs/LESSONS.md with a concrete prevention rule. Use when asked to remember a lesson or after a meaningful correction.
---
